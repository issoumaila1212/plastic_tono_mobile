...
/******************///////cloturer/////////////////////////////////////§§§§§§§§§§§§§§§§§§§§§§§§§§§§*********************************
        /*Future<String> cloturerSession(int idSession) async {
          ...
          Future<double> fetchPoidsSession(int idSession) async {
...
///////////////////******************espace points******************////////////////////////////////////////////////////
          ...
          Future<void> enregistrerPoints(int sessionId, double poids) async {
            final String url = "$baseUrl/enregistrerPoints/$sessionId?poids=$poids";
